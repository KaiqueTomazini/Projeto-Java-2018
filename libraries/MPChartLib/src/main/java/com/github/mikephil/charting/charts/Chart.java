...
public abstract class Chart<T extends ChartData<? extends IDataSet<? extends Entry>>> extends
     ...
     * @param l
     */
    public Chart setOnChartValueSelectedListener(OnChartValueSelectedListener l) {
    ...
    public Bitmap getChartBitmap(CompressFormat compressFormat) {
        // Define a bitmap with the same size as the view
        Bitmap returnedBitmap = Bitmap.createBitmap(getWidth(), getHeight(), Bitmap.Config.ARGB_8888);
        // Bind a canvas to it
        Canvas canvas = new Canvas(returnedBitmap);
    ...
    public boolean saveToPath(String title, String pathOnSD) {
        ...
        Bitmap b = getChartBitmap(CompressFormat.PNG);

        OutputStream stream = null;
        try {
            File file = new File(Environment.getExternalStorageDirectory().getPath(), pathOnSD);
            if (!file.exists())
                if (!file.mkdirs())
                    return false;
            stream = new FileOutputStream(new File(file, title + ".png"));
    ...
    public boolean saveToGallery(String fileName, String subFolderPath, String fileDescription, Bitmap.CompressFormat
        ...
        try {
            ...
            Bitmap b = getChartBitmap(format);
    ...
    public boolean saveToGallery(String fileName, int quality, CompressFormat format) {
        return saveToGallery(fileName, "", "MPAndroidChart-Library Save", format, quality);
    }
